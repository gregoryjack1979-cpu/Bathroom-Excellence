      ...
      {show && (
        ...
        >
          <div className="relative flex flex-col items-center">
            ...
            >
              <path d="M13 1.5C13 1.5 3 13.2 3 19.4a10 10 0 0 0 20 0C23 13.2 13 1.5 13 1.5Z" fill="#9fb3bc" />
            </motion.svg>
            {/* ripple rings */}
            {[0, 1].map((i) => (
              <motion.span
                key={i}
                className="absolute left-1/2 top-6 h-6 w-6 -translate-x-1/2 rounded-full border-2 border-chrome-dark/70"
