...
const problems = [
  {
    ...
    icon: (
      <svg viewBox="0 0 48 48" fill="none" aria-hidden="true">
        <rect x="6" y="6" width="36" height="36" rx="6" fill="#d8edf2" />
        ...
        <path d="M12 14h24M12 20h24" stroke="#9fc0c9" strokeWidth="2" strokeLinecap="round" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 48 48" fill="none" aria-hidden="true">
        <rect x="6" y="6" width="36" height="36" rx="6" fill="#d8edf2" />
        <path d="M6 24h36M24 6v36" stroke="#9fc0c9" strokeWidth="2" />
        <path d="m14 12 6 5-3 5 5 4" stroke="#0f5e73" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M30 30l5 4-2 6" stroke="#0f5e73" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 48 48" fill="none" aria-hidden="true">
        <rect x="6" y="6" width="36" height="36" rx="6" fill="#d8edf2" />
        <path d="M14 14h10a6 6 0 0 1 6 6v2" stroke="#0f5e73" strokeWidth="3" strokeLinecap="round" />
        <rect x="26" y="22" width="8" height="6" rx="2" fill="#0f5e73" />
        <path
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 48 48" fill="none" aria-hidden="true">
        <rect x="6" y="6" width="36" height="36" rx="6" fill="#d8edf2" />
        <rect x="12" y="10" width="24" height="30" rx="2" stroke="#0f5e73" strokeWidth="2.4" />
        <path d="m17 16 8 10-5 8" stroke="#2a93ac" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" />
        <circle cx="31" cy="26" r="2" fill="#0f5e73" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 48 48" fill="none" aria-hidden="true">
        <rect x="6" y="6" width="36" height="36" rx="6" fill="#d8edf2" />
        <circle cx="24" cy="24" r="11" stroke="#0f5e73" strokeWidth="2.4" />
        <path d="M24 17v7l5 4" stroke="#0f5e73" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M37 11l4 4M41 11l-4 4" stroke="#2a93ac" strokeWidth="2.2" strokeLinecap="round" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 48 48" fill="none" aria-hidden="true">
        <rect x="6" y="6" width="36" height="36" rx="6" fill="#d8edf2" />
        <path d="M10 36h28" stroke="#9fc0c9" strokeWidth="2.4" strokeLinecap="round" />
        <path d="M14 30h8l4-8" stroke="#0f5e73" strokeWidth="2.6" strokeLinecap="round" strokeLinejoin="round" />
        <circle cx="28" cy="14" r="3.5" fill="#0f5e73" />
        <path d="M26 20l-5 6M34 34l-4-9" stroke="#0f5e73" strokeWidth="2.6" strokeLinecap="round" />
      </svg>
    ),
  },
];
